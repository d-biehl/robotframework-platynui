...
#[case(
    ...
    "Complex predicate with regex and functions"
)]
#[case(
    "//book[@isbn and string-length(@isbn) = 13]/title[normalize-space(.) != '']",
    "Complex path with string functions"
)]
#[case(
...
#[case(
    ...
    "Position and modulo operations"
)]
#[case(
    "//table[count(tr) > 10 and @id and starts-with(@class, 'data')]",
    "Count function with complex conditions"
)]
#[case(
...
#[case(
    ...
    "Complex element text conditions"
)]
#[case(
    "//book[(@price * @discount div 100) < 20 and @published > 2020]",
    "Mathematical expressions in predicates"
)]
...
#[case(
    ...
    "div with div arithmetic keyword in path"
)]
...
#[case(
    ...
    "mod element with namespaced attribute"
)]
