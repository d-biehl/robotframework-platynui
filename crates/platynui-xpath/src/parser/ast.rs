...
#[derive(Debug, Clone, PartialEq)]
pub enum UnarySign { Plus, Minus }

#[derive(Debug, Clone, PartialEq)]
pub enum BinaryOp { Add, Sub, Mul, Div, IDiv, Mod, And, Or }

#[derive(Debug, Clone, PartialEq)]
pub enum GeneralComp { Eq, Ne, Lt, Le, Gt, Ge }

#[derive(Debug, Clone, PartialEq)]
pub enum ValueComp { Eq, Ne, Lt, Le, Gt, Ge }

#[derive(Debug, Clone, PartialEq)]
pub enum NodeComp { Is, Precedes, Follows }
...
#[derive(Debug, Clone, PartialEq)]
pub enum Quantifier { Some, Every }

#[derive(Debug, Clone, PartialEq)]
pub struct QuantifiedBinding { pub var: QName, pub in_expr: Expr }

#[derive(Debug, Clone, PartialEq)]
pub struct ForBinding { pub var: QName, pub in_expr: Expr }

#[derive(Debug, Clone, PartialEq)]
pub struct LetBinding { pub var: QName, pub value: Expr }

// ===== Paths and steps =====

#[derive(Debug, Clone, PartialEq)]
pub enum PathStart { Root, RootDescendant, Relative }

#[derive(Debug, Clone, PartialEq)]
pub struct PathExpr { pub start: PathStart, pub steps: Vec<Step> }
...
#[derive(Debug, Clone, PartialEq)]
pub struct Step { pub axis: Axis, pub test: NodeTest, pub predicates: Vec<Expr> }

#[derive(Debug, Clone, PartialEq)]
pub enum NodeTest { Name(NameTest), Kind(KindTest) }

#[derive(Debug, Clone, PartialEq)]
pub enum NameTest { QName(QName), Wildcard(WildcardName) }

#[derive(Debug, Clone, PartialEq)]
pub enum WildcardName { Any, NsWildcard(String), LocalWildcard(String) }
...
#[derive(Debug, Clone, PartialEq)]
pub enum ElementNameOrWildcard { Name(QName), Any }

#[derive(Debug, Clone, PartialEq)]
pub enum AttributeNameOrWildcard { Name(QName), Any }
...
#[derive(Debug, Clone, PartialEq)]
pub struct SingleType { pub atomic: QName, pub optional: bool }

#[derive(Debug, Clone, PartialEq)]
pub enum Occurrence { One, ZeroOrOne, ZeroOrMore, OneOrMore }

#[derive(Debug, Clone, PartialEq)]
pub enum ItemType { Kind(KindTest), Item, Atomic(QName) }

#[derive(Debug, Clone, PartialEq)]
pub enum SequenceType { EmptySequence, Typed { item: ItemType, occ: Occurrence } }
