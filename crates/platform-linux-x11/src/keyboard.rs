...
const NAMED_KEYS: &[(&str, u32, bool)] = &[
    ...
    ("LEFTSHIFT", XK_SHIFT_L, true),
    ("RSHIFT", XK_SHIFT_R, true),
    ("RIGHTSHIFT", XK_SHIFT_R, true),
    ("CONTROL", XK_CONTROL_L, true),
    ("CTRL", XK_CONTROL_L, true),
    ("LCONTROL", XK_CONTROL_L, true),
    ("LCTRL", XK_CONTROL_L, true),
    ("LEFTCONTROL", XK_CONTROL_L, true),
    ("LEFTCTRL", XK_CONTROL_L, true),
    ("RCONTROL", XK_CONTROL_R, true),
    ("RCTRL", XK_CONTROL_R, true),
    ("RIGHTCONTROL", XK_CONTROL_R, true),
    ("RIGHTCTRL", XK_CONTROL_R, true),
    ("ALT", XK_ALT_L, true),
    ("LALT", XK_ALT_L, true),
    ("LEFTALT", XK_ALT_L, true),
    ("LMENU", XK_ALT_L, true),
    ("RALT", XK_ALT_R, true),
    ("RIGHTALT", XK_ALT_R, true),
    ("RMENU", XK_ALT_R, true),
    ("ALTGR", XK_ALT_R, true),
    ("META", XK_META_L, true),
    ...
    ("LEFTWIN", XK_SUPER_L, true),
    ("RWIN", XK_SUPER_R, true),
    ("RIGHTWIN", XK_SUPER_R, true),
