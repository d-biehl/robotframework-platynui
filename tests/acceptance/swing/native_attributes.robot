...
...                 1-based; 4×3 grid → cell (row, col) is child [row*3 + col + 1]), never by @Name:
...                 the JDK's AccessBridge answers JTable cell lookups with the one shared
...
The Table Reports Its Dimensions And Selection Counts
    ...
    BM.Get Attribute    .//*[@Name="main-table"]    native:Table.RowCount    ==    ${4}
    BM.Get Attribute    .//*[@Name="main-table"]    native:Table.ColumnCount    ==    ${3}
...
A Data Cell Reports Its Coordinates
    ...
    ...    the preselected row.
    BM.Get Attribute    .//*[@Name="main-table"]/*[6]    native:TableCell.Row    ==    ${1}
    BM.Get Attribute    .//*[@Name="main-table"]/*[6]    native:TableCell.Column    ==    ${2}
    BM.Get Attribute    .//*[@Name="main-table"]/*[6]    native:TableCell.RowExtent    ==    ${1}
    BM.Get Attribute    .//*[@Name="main-table"]/*[6]    native:TableCell.ColumnExtent    ==    ${1}
    BM.Get Attribute    .//*[@Name="main-table"]/*[6]    native:TableCell.IsSelected    ==    ${False}

A Cell In The Preselected Row Reports Its Selection
    [Documentation]    The table's 8th child is cell (2, 1) — inside the preselected row 2.
    BM.Get Attribute    .//*[@Name="main-table"]/*[8]    native:TableCell.Row    ==    ${2}
    BM.Get Attribute    .//*[@Name="main-table"]/*[8]    native:TableCell.Column    ==    ${1}
    BM.Get Attribute    .//*[@Name="main-table"]/*[8]    native:TableCell.IsSelected    ==    ${True}
