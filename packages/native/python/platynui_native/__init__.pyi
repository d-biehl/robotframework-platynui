...
class Runtime:
    ...
    @staticmethod
    def new_with_providers_and_platforms(provider_handles: List[int], platforms: PlatformOverrides) -> 'Runtime': ...
    def evaluate(self, xpath: str, node: 'UiNode | None' = ...) -> List[Union[UiNode, EvaluatedAttribute, UiValue]]: ...
    def evaluate_single(self, xpath: str, node: 'UiNode | None' = ...) -> Union[UiNode, EvaluatedAttribute, UiValue, None]: ...
    ...
    def highlight(self, rects: list[Rect], duration_ms: float | None = ...) -> None: ...
    def clear_highlight(self) -> None: ...
    def screenshot(self, rect: Rect | None = ..., mime_type: str | None = ...) -> bytes: ...
