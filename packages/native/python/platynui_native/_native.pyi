...
class UiNode:
    ...
    def ancestor_pattern(self, pattern: str | type) -> object | None: ...
    def top_level_pattern(self, pattern: str | type) -> object | None: ...
...
class Runtime:
    ...
    def element_at_point(self, x: float, y: float) -> UiNode | None: ...
