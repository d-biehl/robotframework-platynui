...
- **Breaking**: none for public APIs. `SupportedPatterns` narrowing (Focusable gating) can change XPath results for queries that relied on the buggy always-on advertisement; none exist in-tree.
