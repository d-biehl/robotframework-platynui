...
- [ ] 3.2a Catalog onboarding: self-contained `tests/acceptance/swt/catalog.robot` replicating the canonical catalog test set (reference: `add-qml-test-app`) with the SWT launch config; documented skips for verified SWT/UIA limitations
