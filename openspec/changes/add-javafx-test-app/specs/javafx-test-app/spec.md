...
- **THEN** the canonical catalog tests execute against the JavaFX fixture, and each non-passing catalog test is a documented skip naming its limitation
